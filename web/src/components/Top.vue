<template>
    <div>
        ...
        <div class="main">
            ...
            <div class="left-item">番剧</div>
            <div class="left-item">直播</div>
            <div class="left-item">游戏中心</div>
            <div class="left-item">会员购</div>
            <div class="left-item">漫画</div>
            <div class="left-item">赛事</div>
            <div class="left-item">
                <img class="loc-mc-box__pic"
                     src="../../public/images/love.png" alt="图片">
            </div>
            <div class="download left-item">
            ...
            >
                <div
                        ...
                        @click="toLogin"
                >
                    <img class="sculpture_head" :src="user['sculpture_head']">
                </div>
                <div class="userinfo" v-if="focusBoole">
                    <div class="username">
                        <a class="nickname-item" href="#" target="_blank"
                    ...
                    <div class="source">
                        <a>硬币数:&nbsp;{{ user['number_coin'] }}</a>
                        <a>B币数:&nbsp;{{ user['number_b_coin'] }}</a>
                    </div>
                    <div class="level">
                        <div class="level-low">
                            <svg class="icon" aria-hidden="true">
                                <use :xlink:href="withLevel"></use>
                            </svg>
                        </div>
                        <div class="progress-bar">
                            <div class="bar-low">
                                <div class="bar-height" :style="levelBar"></div>
                            </div>
                        </div>
                        <div class="level-height">
                            <svg class="icon" aria-hidden="true">
                                <use :xlink:href="levelRequired"></use>
                            </svg>
                        </div>
                    </div>
                    <div class="level-info">
                        <span>当前成长{{ user['experience'] }}，距离升级Lv.{{
                            user['level'] + 1
                            }} 还需要{{ user['experience_required'] }}</span>
                    </div>
                    <div class="item">
                        <a>
                            <div>{{ user['number_follow'] }}</div>
                            <div>关注</div>
                        </a>
                        <a>
                            <div>{{ user['number_fans'] }}</div>
                            <div>粉丝</div>
                        </a>
                        <a>
                            <div>2</div>
                    ...
                    <div class="link-list">
                        <div>
                            <a href="https://account.bilibili.com/account/home" class="single-link-item"
                               target="_blank">
                        ...
                        <div>
                            <a href="https://member.bilibili.com/v2#/upload-manager/article" class="single-link-item"
                               target="_blank">
                                <div class="link-title">
                                    <svg width="18" height="18" viewBox="0 0 18 18"
                                         xmlns="http://www.w3.org/2000/svg" class="link-icon">
                    ...
                    <li>
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g clip-path="url(#clip0)">
                                <path d="M10 10.743C7.69883 10.743 5.83333 8.87747 5.83333 6.5763C5.83333 4.27512 7.69883 2.40964 10 2.40964V10.743Z"
                                      stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"></path>
                                <path d="M10 10.743C10 13.0441 8.1345 14.9096 5.83333 14.9096C3.53217 14.9096 1.66667 13.0441 1.66667 10.743H10Z"
                                      stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"></path>
                                <path d="M10 10.743C10 8.44182 11.8655 6.57632 14.1667 6.57632C16.4679 6.57632 18.3333 8.44182 18.3333 10.743H10Z"
                                      stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"></path>
                                <path d="M9.99999 10.743C12.3012 10.743 14.1667 12.6085 14.1667 14.9096C14.1667 17.2108 12.3012 19.0763 9.99999 19.0763V10.743Z"
                                      stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"></path>
                            </g>
                            <defs>
                                <clipPath id="clip0">
                ...
                <ul>
                    <li>
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path d="M11.603 11.8739C11.413 12.5556 10.7871 13.0554 10.0447 13.0554C9.29592 13.0554 8.66679 12.5467 8.48242 11.8569"
                                  stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                                  stroke-linejoin="round"></path>
                        </svg>
                    </li>
            ...
            <div class="header-upload-entry" @click="uploadHandler">
                <div>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"
                         class="header-upload-entry__icon">
                        <path d="M12.0824 10H14.1412C15.0508 10 15.7882 10.7374 15.7882 11.6471V12.8824C15.7882 13.792 15.0508 14.5294 14.1412 14.5294H3.84707C2.93743 14.5294 2.20001 13.792 2.20001 12.8824V11.6471C2.20001 10.7374 2.93743 10 3.84707 10H5.90589"
...
export default {
    ...
    computed: {
        ...mapState("login", ["user"]),
        withLevel() {
            let l = this.user['level']
            return `#icon-color-${l}`
        },
        levelRequired() {
            let l = this.user['level']
            return `#icon-required-${l + 1}`
        },
        levelBar() {
            let s = this.user['experience'] / (this.user['experience_required'] + this.user['experience'])
            return `--width:${s * 100}%`
        }
    },
    data() {
        return {
            focusBoole: false,
            login_show: false,
            sculpture_head: "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg9.doubanio.com%2Fview%2Frichtext%2Flarge%2Fpublic%2Fp206988865.jpg&refer=http%3A%2F%2Fimg9.doubanio.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1686663263&t=e2524c83a23cc3503ab6970933ab41fa"
        }
    },
    methods: {
        ...
        mouseenterHandler() {
            const token = getToken()
            console.log(token)
            this.focusBoole = true
        },
        mouseleaveHandler() {
            this.focusBoole = false
        },
        uploadHandler() {
            this.$router.push({
                path: "/contribute"
...
.head-main:hover .sculpture_head {
    transform: scale(2, 2);
...
.level-low svg, .level-height svg {
    width: 50px;
    height: 30px;
}
